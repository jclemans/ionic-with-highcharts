...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = angular.module('starter', ['ionic', 'highcharts-ng']).controller('AppCtrl', function ($scope) {
	  $scope.chartConfig = {
	    options: {
	      chart: {
	        type: 'bar'
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  angular.module('highcharts-ng', []).factory('highchartsNGUtils', highchartsNGUtils).directive('highchart', ['highchartsNGUtils', '$timeout', highchart]);
	  function highchartsNGUtils() {
	    return {
	      indexOf: function indexOf(arr, find, i) {
	        if (i === undefined) i = 0;
	        if (i < 0) i += arr.length;
	        if (i < 0) i = 0;
	      ...
	      prependMethod: function prependMethod(obj, method, func) {
	  ...
	  function highchart(highchartsNGUtils, $timeout) {
	    ...
	    var seriesId = 0;
	    var ensureIds = function ensureIds(series) {
	      var changed = false;
	    ...
	    var getMergedOptions = function getMergedOptions(scope, element, config) {
	      var mergedOptions = {};
	      var defaultOptions = {
	        chart: { events: {} },
	        title: {},
	    ...
	    var updateZoom = function updateZoom(axis, modelAxis) {
	      var extremes = axis.getExtremes();
	      if (modelAxis.currentMin !== extremes.dataMin || modelAxis.currentMax !== extremes.dataMax) {
	        axis.setExtremes(modelAxis.currentMin, modelAxis.currentMax, false);
	      }
	    };
	    var processExtremes = function processExtremes(chart, axis, axisName) {
	      if (axis.currentMin || axis.currentMax) {
	        chart[axisName][0].setExtremes(axis.currentMin, axis.currentMax, true);
	      }
	    };
	    var chartOptionsWithoutEasyOptions = function chartOptionsWithoutEasyOptions(options) {
	      return highchartsNGUtils.deepExtend({}, options, {
	        data: null,
	        visible: null
	      });
	    };
	    var getChartType = function getChartType(scope) {
	    ...
	    return {
	      ...
	      link: function link(scope, element, attrs) {
	        ...
	        var processSeries = function processSeries(series) {
	          var i;
	          var ids = [];
	          if (series) {
